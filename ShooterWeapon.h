...
public:
	...
	void SetCurrentAmmoInClip(int ammoInClip);
...
protected:
	...
	/** play weapon sounds */
	UAudioComponent* PlayWeaponSound(USoundCue* Sound, float PitchRate);

	/** play weapon animations */
	float PlayWeaponAnimation(const FWeaponAnim& Animation, float PlaySpeed);
